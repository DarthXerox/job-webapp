...
namespace DAL.Migrations
{
    ...
    [Migration("20210107002834_SkillChangedToString")]
    partial class SkillChangedToString
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Entities.JobApplication", b =>
                {
                    b.HasOne("DAL.Entities.JobSeeker", "Applicant")
                        .WithOne()
                        .HasForeignKey("DAL.Entities.JobApplication", "ApplicantId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("DAL.Entities.JobOffer", "JobOffer")
                        .WithOne()
                        .HasForeignKey("DAL.Entities.JobApplication", "JobOfferId")
                        .OnDelete(DeleteBehavior.Restrict);
                });

            modelBuilder.Entity("DAL.Entities.JobApplicationAnswer", b =>
                {
                    b.HasOne("DAL.Entities.JobApplication", null)
                        .WithMany("Answers")
                    ...
                    b.HasOne("DAL.Entities.JobOfferQuestion", "Question")
                        .WithOne()
                        .HasForeignKey("DAL.Entities.JobApplicationAnswer", "QuestionId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("DAL.Entities.JobOfferQuestion", b =>
                {
                    b.HasOne("DAL.Entities.JobOffer", null)
                        .WithMany("Questions")
